...
export default function LoginRegister() {
  ...
  const handleLogin = async (e) => {
    ...
    setMsg("");
    try {
      const res = await fetch("https://logica-tiendaenlina.onrender.com/api/login", {
        method: "POST",
  ...
  const handleRegister = async (e) => {
    ...
    setMsg("");
    try {
      const res = await fetch("https://logica-tiendaenlina.onrender.com/api/registro", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
      ...
      if (
        ...
        try {
          const loginRes = await fetch("https://logica-tiendaenlina.onrender.com/api/login", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({
